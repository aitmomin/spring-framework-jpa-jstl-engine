...
<div class="container-fluid text-center">    
  <div class="row content">
	...
	<div class="container">
	  ...
	  <f:form modelAttribute="factureModel" method="GET" action="creerFacture">
		<div class="col-sm-4">
	   	  <div class="form-group">
	      	<label>Commentaires:</label>
	      	<f:input type="text" class="form-control" placeholder="Commentaires" path="commentaires" />
	      </div>	
	      <div class="form-group">
	      	<label>Client:</label>
	      	<f:input type="text" class="form-control" placeholder="Client" path="idClient" />
	      </div>    
	      <div class="form-group">
