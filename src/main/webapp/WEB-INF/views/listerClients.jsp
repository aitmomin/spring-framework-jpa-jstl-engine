  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      ...
      <div class="container">
		  ...
		  <f:form modelAttribute="ListeClientAdresseModel" method="post" action="listerClients">
		  	<c:if test="${not empty laliste}">		           
				  <table class="table table-striped">
				    <thead>
				      <tr>
				        ...
				        <th>adresseFacturation</th>
				      </tr>
				    </thead>
				    <tbody>
				    	<%
				    	List<Client> l = (List<Client>)request.getAttribute("laliste");
						for(Client c : l){				    	
				    	%>
					      <tr>
					        <td><%=c.getIdClient()%></td>
					    	...
					    	<td><%=c.getAdresseLivraison().getLigne1()+" "+c.getAdresseLivraison().getLigne2()
					    			+" "+c.getAdresseLivraison().getVille()
					    	%></td>	
					        <td><%=c.getAdresseFacturation().getLigne1()+" "+c.getAdresseFacturation().getLigne2()
					    			+" "+c.getAdresseFacturation().getVille()
					        %></td>					        
					      </tr>
					    <% }%> 		      
				    </tbody>
