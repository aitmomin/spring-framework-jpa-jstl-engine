...
<div class="container-fluid text-center">    
  <div class="row content">
	...
	<div class="container">
	  ...
	  <f:form modelAttribute="articleModel" method="GET" action="creerArticle">
		<div class="col-sm-4">
	   	  <div class="form-group">
	      	<label>Prix:</label>
	      	<f:input type="text" class="form-control" placeholder="Entrer le prix" path="prix" />
	      </div>	    
	      <div class="form-group">
	      	<label>Article Description :</label>
	      	<f:input type="text" class="form-control" placeholder="Article Description" path="idDescription" />
	      </div>
