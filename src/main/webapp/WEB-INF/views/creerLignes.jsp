...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      ...
      <hr>
	<div class="container">
	  <h4>* Créer des lignes de Facture :</h4>
	  	  <f:form modelAttribute="ligneFactureModel" method="GET" action="creerLignes">
			<div class="col-sm-4">
		   	  <div class="form-group">
		      	<label>Nombre des articles :</label>
		      	<f:input type="text" class="form-control" placeholder="Nombre des articles" path="nbrArticle" />
		      </div>	
		      <div class="form-group">
		      	<label>Article :</label>
		      	<f:input type="text" class="form-control" placeholder="Article" path="idArticle" />
		      </div>    
		      <div class="form-group">
		      	<label>Facture :</label>
