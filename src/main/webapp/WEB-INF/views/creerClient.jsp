...
<div class="container-fluid text-center">    
  <div class="row content">
	...
	<div class="container">
	  ...
	  <f:form modelAttribute="clientModel" method="GET" action="creerClient">
		<div class="col-sm-4">
	      <div class="form-group">
	      	<label>Nom client :</label>
	      	<f:input type="text" class="form-control" placeholder="Entrer le nom" path="nomClient" />
	      </div>
	   	  <div class="form-group">
	      	<label>Prénom Client :</label>
	      	<f:input type="text" class="form-control" placeholder="Entrer le prénom" path="prenomClient" />
	      </div>	    
	      <div class="form-group">
	      	<label>Adresse Livraison :</label>
	      	<f:input type="text" class="form-control" placeholder="Adresse Livraison" path="idAdresseLivraison" />
	      </div>
	      <div class="form-group">
	      	<label>Adresse Facturation :</label>
	      	<f:input type="text" class="form-control" placeholder="Adresse Facturation" path="idAdresseFacturation"/>
	      </div>
