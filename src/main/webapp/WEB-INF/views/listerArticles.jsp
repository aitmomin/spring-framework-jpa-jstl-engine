  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      ...
      <div class="container">
		  ...
		  <f:form modelAttribute="listeArticleDescriptionModel" method="post" action="listerArticles">
		  	<c:if test="${not empty listeArt}">		           
				  <table class="table table-striped">
				    ...
				    <tbody>
				    	<%
				    	List<Article> l = (List<Article>)request.getAttribute("listeArt");
						for(Article a : l){				    	
				    	%>
					      <tr>
					        <td><%=a.getRef()%></td>
					        <td><%=a.getPrix()%> Dhs</td>
					        <td><%=a.getDescription().getDescription()%></td>				        
					      </tr>
					    <% }%> 		      
				    </tbody>
				  </table>
